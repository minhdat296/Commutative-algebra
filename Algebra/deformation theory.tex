\chapter{Deformation theory}
    ...
    \section{Deformations in derived algebraic geometry}
        ...
        \subsection{(Pro-)cotangent complexes}
            ...
            \subsubsection{(Pro-)cotangent complexes}
    ...
    \section{Formal schemes and inf-schemes}
        \subsection{Formal schemes}
            \subsubsection{The geomety of formal schemes}
                ...
                \begin{remark}
                    ...
                    wherein the \say{intersection} is taken at both the level of objects and of (higher) morphisms; here $(\Spec \Z)$ denotes the $\infty$-topos of presheaves of $\infty$-groupoids on ${}^{\leq 0, \Z/}\Comm\Alg^{\op}$ (cf. convention \ref{conv: derived_algebraic_stacks_notations}). 
                \end{remark}
