        ...
        \subsection{Perverse sheaves on the affine Grassmannian}
            \subsubsection{Beauville-Laszlo Uniformisation and the affine Grassmannian}
                ...
                \paragraph{The affine Grassmannian}
                    ...
                    \end{convention}
                    \begin{definition}[Global affine Grassmannian] \label{def: global_affine_grassmannians}
                    ...
                    \begin{lemma}[Affine Grassmannians as coset spaces] \label{lemma: affine_grassmannians_as_coset_spaces}
