\chapter{D-modules in geometric representation theory}
    ...
    \section{Localisations of Lie algebras}
        \subsection{The Borel-Weil-Bott Theorem}
            ...
            \subsubsection{Cohomology of \texorpdfstring{$\D^{(\lambda)}$}{}-modules}
            
            \subsubsection{The Borel-Weil-Bott Theorem over \texorpdfstring{$\bbC$}{}}
        ...
        \subsection{Localisation of \texorpdfstring{$\g$}{}-modules; the Beilinson-Bernstein Equivalence}
            ...
            \subsubsection{The idea behind the theorem}
                ...
                which in turn induces a (compatible) \say{twisted} pullback functor:
            ...
            \subsubsection{Kazhdan-Lusztig modules, the category \texorpdfstring{$\rmO$}{}, and Verma modules}
        ...
        \subsection{D-modules on the affine Grassmannians and representations of Kac-Moody algebras} \label{subsection: localisation_of_affine_lie_algebras}
