\chapter{\'Etale cohomology for schemes} \label{chapter: etale_cohomology_1}
    ...
    \section{Class field theory}
        \subsection{Local class field theory and the \texorpdfstring{$p$}{}-adic Local Langlands Correspondence for \texorpdfstring{$\GL_1$}{}}
